...
## you can see the  diffrent result below accessing directly each container or when accessing the nginx-loadbalancer:
...
### Curl to URL 
![alt text](https://github.com/YoniSneOr/LavaProject/blob/main/pictures/image32.png)

### Curl to URL load balancer

![alt text](https://github.com/YoniSneOr/LavaProject/blob/main/pictures/image33.png)
...
You can customize the Flask app by modifying the code in the `app.py` file.
